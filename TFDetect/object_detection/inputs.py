...
def assert_or_prune_invalid_boxes(boxes):
  ...
  Raises:
    tf.errors.InvalidArgumentError: When we tf_detect_api boxes with invalid size.
...
def pad_input_data_to_static_shapes(tensor_dict,
  ...
  Raises:
    ValueError: If groundtruth classes is neither rank 1 nor rank 2, or if we
      tf_detect_api that additional channels have not been concatenated yet, or if
